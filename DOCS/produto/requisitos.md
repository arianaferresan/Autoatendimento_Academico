...
| RF02 | Repositório de conhecimento | O sistema deve manter base estruturada com nós de navegação, perguntas, respostas, documentos, chunks e metadados. |
...
| RNF02 | Desempenho | O sistema deve responder rapidamente, inclusive em consultas ao banco e recuperação de trechos documentais. |
