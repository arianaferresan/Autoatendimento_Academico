...
| BD01 | Administração e Operação | Gestão de documentos, chunks e metadados | ![Prioridade Alta](https://img.shields.io/badge/Prioridade-Alta-red) | Concluir a gestão administrativa de documentos e evidências iniciada na Sprint 2, incluindo cadastro, edição e remoção. |
