...
| --- | --- | --- |
| DW01 / RF01 | ![Prioridade Alta](https://img.shields.io/badge/Prioridade-Alta-red) | Conteúdo inicial por curso validado com a secretaria, mensagem de abertura aprovada e nó raiz da conversa modelado no banco. |
| DW02 / RF01 | ![Prioridade Alta](https://img.shields.io/badge/Prioridade-Alta-red) | Árvore de navegação por curso mapeada, estrutura de nós e opções definida e comportamento de retorno planejado. |
