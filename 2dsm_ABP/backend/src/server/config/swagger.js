    ...
    paths: {
        ...
        "/api/options": {
            get: {
                ...
                description: "Retorna o menu principal de opções para iniciar a conversa. Equivalente a chamar a rota com ID 0.",
                responses: {
                    "200": {
                        description: "Sucesso. Retorna { type: 'menu', options: [...] } com as opções raiz.",
                    },
                ...
                parameters: [
                    {
                        ...
                        in: "path",
                        required: true,
                        description: "ID do nó atual clicado pelo usuário. Use 0 para obter o menu inicial.",
                        schema: { type: "integer" },
                    },
                ],
                responses: {
        ...
        "/api/perguntas": {
            post: {
                ...
                description: "Permite que um usuário do chatbot envie uma dúvida para ser respondida pela secretaria. Corresponde à função createSupportContact.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/logs": {
            post: {
                ...
                description: "Registra o fluxo de navegação do usuário, as respostas consultadas e a avaliação de satisfação.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/admin/logs": {
            get: {
                ...
                security: [{ bearerAuth: [] }],
                description: "Retorna um histórico de todas as interações dos usuários com o chatbot.",
                parameters: [
                    {
                        name: "limit",
                        in: "query",
                    ...
                    },
                    {
                        name: "offset",
                        in: "query",
                        description: "Número de registros a pular para paginação (padrão: 0).",
        ...
        "/admin/logs/stats": {
            get: {
                ...
                security: [{ bearerAuth: [] }],
                description: "Agrupa os logs por mês e categoria (curso/perfil) para gerar estatísticas de uso do chatbot.",
                responses: {
                    "200": {
        ...
        "/admin/logs/inquiry-stats": {
            get: {
                ...
                security: [{ bearerAuth: [] }],
                description: "Analisa todos os logs, desagrega os IDs das perguntas (inquiry_ids) e retorna a contagem de quantas vezes cada ID foi acessado. Ideal para gerar histogramas de perguntas mais frequentes.",
                responses: {
                    "200": {
                        description: "Estatísticas retornadas com sucesso.",
                        content: {
                                    ...
                                    items: {
                                        ...
                                        properties: {
                                            month: {
                                                type: "string",
                                                example: "2026-06",
                                                description: "Mês em que os acessos foram registrados (formato YYYY-MM).",
                                            },
                                            inquiry_id: {
                                                type: "integer",
                                                example: 15,
                                            ...
                                            title: {
                                                type: "string",
                                                example: "Qual o horário de funcionamento da secretaria?",
                                                description: "Título da pergunta final acessada.",
                                            },
                                            count: {
                                                type: "integer",
                                                example: 87,
                                                description: "Número de vezes que a pergunta foi acessada no mês.",
                                            },
                                        },
                                    },
                                },
        ...
        "/admin/logs/inquiry-stats-leaf": {
            get: {
                tags: ["Admin - Logs"],
                summary: "Retorna a contagem de cada pergunta final (nó folha) acessada",
                security: [{ bearerAuth: [] }],
                description: "Analisa todos os logs, desagrega os IDs das perguntas e retorna a contagem de quantas vezes cada **nó folha (resposta final)** foi acessado. Ideal para gerar histogramas de perguntas mais frequentes.",
                responses: {
                    "200": {
                        description: "Estatísticas retornadas com sucesso.",
                        content: {
        ...
        "/admin/perguntas": {
            get: {
                ...
                description: "Retorna uma lista de todos os contatos de suporte (perguntas) para gerenciamento pela secretaria.",
                parameters: [
                    {
                        name: "limit",
                        in: "query",
        ...
        "/admin/perguntas/stats": {
            get: {
                ...
                security: [{ bearerAuth: [] }],
                description: "Agrupa as perguntas por status (ABERTA, ATENDIMENTO, RESPONDIDA) e retorna a contagem de cada um.",
                responses: {
                    "200": {
                        description: "Estatísticas retornadas com sucesso.",
                        content: {
        ...
        "/auth/login": {
            post: {
                ...
                description: "Realiza o login de um usuário com perfil 'admin' ou 'secretaria' e retorna um token de acesso.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/auth/me": {
            get: {
                ...
                description: "Verifica o token JWT fornecido e retorna as informações do usuário logado (id, email, role).",
                security: [
                    {
                        bearerAuth: [],
                    },
                ...
                responses: {
                    ...
                    "401": {
                        description: "Não autenticado (token não fornecido, inválido ou expirado).",
                    },
                },
            },
        },
